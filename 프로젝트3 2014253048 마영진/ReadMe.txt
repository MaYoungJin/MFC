================================================================================
    MFC 라이브러리 : 프로젝트3 2014253048 마영진 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 프로젝트3 2014253048 마영진 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.

프로젝트3 2014253048 마영진 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

프로젝트3 2014253048 마영진.vcxproj
...
프로젝트3 2014253048 마영진.vcxproj.filters
...
프로젝트3 2014253048 마영진.h
    해당 응용 프로그램의 기본 헤더 파일입니다.
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 C프로젝트32014253048마영진App 응용 프로그램 클래스가 선언되어 있습니다.

프로젝트3 2014253048 마영진.cpp
    이는 응용 프로그램 클래스 C프로젝트32014253048마영진App가 포함된 기본 응용 프로그램 소스 파일입니다.

프로젝트3 2014253048 마영진.rc
...
res\프로젝트3 2014253048 마영진.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 프로젝트3 2014253048 마영진.rc에 의해 포함됩니다.

res\My32014253048.rc2
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 프로젝트3 2014253048 마영진.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
